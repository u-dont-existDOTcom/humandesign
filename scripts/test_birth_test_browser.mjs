...
try {
  ...
  await page.waitForFunction(() => !document.getElementById('result-section').classList.contains('hidden'), null, { timeout: 60000 });
  ...
  await page.locator('#check').click();
  await page.waitForFunction(() => document.getElementById('checked-result').innerText.includes('Your score is 4'), null, { timeout: 60000 });
