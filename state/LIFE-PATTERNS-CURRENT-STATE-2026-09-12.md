...
Next gate: **OWNER REAL-DATA BROWSER JUDGMENT REQUIRED**. Use the deployed owner-only service to test repeated pattern threads, finish-for-now summary, and optional copy/export.
