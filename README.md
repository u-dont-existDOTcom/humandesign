...
See [`CURRENT_PLAN.md`](CURRENT_PLAN.md) for the latest consolidated research design, including the month-first blind test, post-hoc human fitting, responder heterogeneity, and exact-state timing rules.
